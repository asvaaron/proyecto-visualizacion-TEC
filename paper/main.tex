...
La electricidad corresponde a un pilar fundamental para el progreso de un país y forma parte importante de su éxito dentro de un mundo globalizado. 
...
Para la realización de este trabajo se decidió utilizar la metodología propuesta por Benjamín Fry \cite{fry_visualizing_2007}, este método consta de siete etapas:
\begin{itemize}
