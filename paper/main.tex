...
Para la estructuración, consulta y acceso a los datos se utilizo el servicio de \href{https://cloud.google.com/products/bigquery/}{BigQuery} a demás permite la integración y consulta muchas bases de datos publicas entre las cuales esta la base de datos del Banco Mundial.
