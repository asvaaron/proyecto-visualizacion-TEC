...
BigQuery es un almacen de datos en la nube sin servidores, gratuito para consulta de bases de datos publicas y altamente escalable. Permite consultar grandes cantidades de datos estructurados o semi-estructurados mediante el uso de SQL, lo que nos facilito la revisión y   
a demás permite la integración y consulta muchas bases de datos publicas entre las cuales esta la base de datos del Banco Mundial.
